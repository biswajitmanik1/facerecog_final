const badges = [
  ...
  { label: 'Flask', color: 'bg-emerald-500/20 text-emerald-300 border-emerald-500/30' },
    ...
    <section id="about" className="py-24 px-4 bg-gray-900">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-lg leading-relaxed mb-10">
          Smart Attendance combines a Python/Flask backend with an OpenCV-powered face recognition pipeline, 
          a React frontend, and MongoDB storage. Designed for real educational institutions looking to 
